...
//                return StrongStrengthCardFragment.newInstance(1, NUM_ITEMS, assessmentList.get(0).getStrength(), assessmentList.get(1).getStrength());
            ...
            case 0: {
                return WeakStrengthCardFragment.newInstance(1, NUM_ITEMS, assessmentList.get(listSize - 1).getStrength(), assessmentList.get(listSize - 2).getStrength(), assessmentList.get(listSize - 3).getStrength());
            }
            case 1:
                return ImprovementTipsCardFragment.newInstance(2, NUM_ITEMS, assessmentList.get(listSize - 1).getStrength());
            case 2:
                return ImprovementTipsCardFragment.newInstance(3, NUM_ITEMS, assessmentList.get(listSize - 2).getStrength());
            case 3:
                return ImprovementTipsCardFragment.newInstance(4, NUM_ITEMS, assessmentList.get(listSize - 3).getStrength());
            default:
                return null;
        }
    }
